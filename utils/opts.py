...
def parse(class_num=157):
    ...
    # net info
    parser.add_argument('--arch', default='resnet50', type=str,help='resnet [34, 50, 101, 152]')
    ...
    parser.add_argument('--lr', '--learning-rate', default=0.008, type=float, metavar='LR', help='init learning rate')
    ...
    # data loader info
    parser.add_argument('-j', '--workers', default=0, type=int, help='data loading workers (default: 4)')

    parser.add_argument('-b', '--batch-size', default=10, type=int, help='mini-batch size (default: 256)')

    parser.add_argument('--train-size', default=0.020, type=float)

    parser.add_argument('--val-size', default=0.02, type=float)

    parser.add_argument('--inputsize', default=224, type=int)

    parser.add_argument('--image_num', default=3, type=int)
